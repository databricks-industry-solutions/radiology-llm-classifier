...
def pred_wrapper(model, tokenizer, prompt, model_id=1, temp=0.1, max_length=100, show_metrics=False):
    """
...
import pandas as pd
df_test = pd.read_csv('/Volumes/ang_nara_catalog/rad_llm/clinical_data/test_batch_data.csv')
